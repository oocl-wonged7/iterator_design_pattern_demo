...
Bootcamp {
    ...
    public static void main(String[] args) {
        ...
        StrictTeacherAssistant strictTeacherAssistant = new StrictTeacherAssistant();
        strictTeacherAssistant.createAStudentNameList(bootcamp.studentsList);
        shangQi.findAssistant(strictTeacherAssistant);
        assistant.reset();
        shangQi.askQuestion();
    }
}
